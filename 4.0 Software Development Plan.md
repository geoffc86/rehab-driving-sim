...
training and test scenarios so that it can be analyzed for research and used
to guide further training. Saved data will remain associated with the user
to judge areas of improvement.
