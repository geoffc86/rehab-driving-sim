...
| Training Scenarios   | Sim Commander, SimTools, PC2, ATS | SimGear, external monitors | TBD             |
| Test Scenarios       | Sim Commander, SimTools, PC2, ATS | SimGear, external monitors | TBD             |
| Data Acquisition     | Sim Commander, SimTools, SCS Software SDK | SimGear            | Geoff           |
| Deliverables         | Google Docs, GitHub, Slack        | N/A         | Geoff, Jackson, Simon, Marissa |
